  ...
  return (
    <a href={project.url} target="_blank" rel="noreferrer" className="group block">
      ...
      <div className="flex items-start justify-between gap-2 sm:gap-4 pt-3">
        <h3 className="font-display uppercase max-md:text-lg text-lg sm:text-xl md:text-2xl leading-[1.15] min-w-0 break-words">{project.title}</h3>
        <span className="text-purple-glow text-lg shrink-0 mt-0.5 group-hover:translate-x-1 group-hover:-translate-y-1 transition">
          ↗
        </span>
      </div>
